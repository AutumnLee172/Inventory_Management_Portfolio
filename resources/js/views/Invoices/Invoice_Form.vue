        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <b-row class="px-1">
                    <b-col md="6">
                        <b-form-group label="Customer Name" label-for="customer_id">
                            <b-form-select id="customer_id" v-model="selectedCustomer">
                                <b-form-select-option v-for="(customer, index) in customers" :value="customer.id"
                                    id="Customer_id" name="customer_id" v-bind:key="index" class="mb-2 mr-sm-2 mb-sm-0">
                ...
                <b-row class="px-1" v-for="(item, index) in items" v-bind:key="index">
                    <b-col md="3">
                        <b-form-group label="Item Number" label-for="item_number">
                    ...
                    <b-col md="1">
                        <b-form-group label="Original Price" label-for="original_price">
                            <b-form-input id="original_price" readonly v-model="item.original_price"></b-form-input>
                        </b-form-group>
                    </b-col>
                    <b-col md="1">
                        <b-form-group label="Selling Price" label-for="original_price">
                    ...
                    <b-col md="1">
                        <b-form-group label="Remove" label-for="remove_button" class="text-center">
                ...
                <b-row class="px-1">
                    <b-col md="6">
                        <b-form-group label="Total" label-for="total">
                            <b-form-input id="total" v-model="form.total" readonly></b-form-input>
                        </b-form-group>
                    </b-col>
                    <b-col md="6">
                        <b-form-group label="Discount" label-for="discount">
                            <b-form-input id="discount" v-model="form.discount"></b-form-input>
                        </b-form-group>
                    </b-col>
                    <b-col md="6">
                        <b-form-group label="Net" label-for="net">
                            <b-form-input id="net" v-model="form.net" readonly></b-form-input>
                        </b-form-group>
                    </b-col>
                    <b-col md="6">
                        <b-form-group label="Deposit" label-for="deposit">
                            <b-form-input id="deposit" v-model="form.deposit"></b-form-input>
                        </b-form-group>
                    </b-col>
                    <b-col md="6">
                        <b-form-group label="Balance" label-for="balance">
                            <b-form-input id="balance" v-model="form.balance" readonly></b-form-input>
                        </b-form-group>
                    </b-col>
                </b-row>
            </div>
    ...
    methods: {
        ...
        findItem(itemNumber, index) {
            ...
            axios
                ...
                .then((r) => {
                    if (r.data && r.data.data) {
                        this.items.splice(index, 1, { item_number: itemNumber, description: r.data.data.description, original_price: r.data.data.original_price, selling_price: r.data.data.selling_price, quantity: '', sub_total: '' })
                    }
                })
                .catch((err) => {
                    // this.isLoading = false;
